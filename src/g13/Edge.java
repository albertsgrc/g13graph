...
public abstract class Edge
{
    ...
    /**
     * @pre True
     * @post An g13.Edge between the nodes n1 and n2 with weight w is created
     * @param m1
     * @param m2
     * @param w
     */
	...
	/**
     * @pre The Node n is part of the g13.Edge
     * @post The other Node from the g13.Edge is returned
     * @param n
     * @return
	 * Given one of the two nodes of the g13.Edge, it returns the other one.
