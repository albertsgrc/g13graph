...
public abstract class Graph {
    ...
    public void deleteNode(Node n) {
        ...
        //We look at each g13.Edge and delete it from its neighbor's set
        for(Edge e : es){
	...
	/**
     * @pre Both Nodes from the g13.Edge e are part of the graph
     * @post The g13.Edge e is added to the graph
     * @param e
	 */
     ...
     * @param n1
     * @param n2
     * @pre THe Nodes n1 and n2 are part of the graph and there is an g13.Edge e between them
     * @post The g13.Edge e is removed from the g13.Graph
	 */
	...
	/**
     * @pre The g13.Edge e is part of the graph
     * @post The g13.Edge e is deleted from the graph
     * @param e
